...
----------
In many engineering applications it is important to be able to mix two fluids efficiently. In combustion engines one needs to mix fuel and air, in chemical processes such as polymer production one needs to mix monomers and reactants, and in lab-on-chip applications one needs to mix samples and reagents. While there are many heuristics for what makes a flow field good at mixing, we do not have a complete mathematical understanding of this behavior. This project aims to characterize maximally efficient mixing fields, thereby giving us a better mathematical understanding of mixing and helping us to design machines and protocols which can mix more effectively. Moreover, this problem provides a valuable case study of continuum control under constraints (in this case, incompressibility).
...
----------
Oscillator Ising Machines (OIMs) are models of coupled-oscillator-based analog computers which are useful for efficiently approximating solutions to combinatorial optimization problems. Here, we study the mean-field (continuum) limit of these OIMs, investigating the roles of symmetry in obtaining reduced-order models and of structural features in their analysis. Moreover, this problem provides a valuable case study of control of continuum systems with nonlocal interactions.
